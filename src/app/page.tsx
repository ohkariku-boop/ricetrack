      ...
      <div className="marquee-track flex w-max gap-0">
        {items.map((item, i) => (
          ...
          >
            ...
            <span className="absolute inset-0 flex items-center justify-center text-[11px] sm:text-[12px] font-semibold tracking-wide text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.5)]">
              {item.cuisine}
            </span>
          </div>
        ))}
    ...
    <div className="min-h-screen bg-[#f6f3ee] text-[#1a1814] antialiased">
      <header className="sticky top-0 z-40 border-b border-[#1a1814]/8 bg-[#f6f3ee]/90 backdrop-blur-md">
        <div className="mx-auto max-w-5xl px-4 h-12 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 font-semibold text-[14px] tracking-tight">
            <RiceLogo size={22} />
            RiceTrack
          </Link>
          <nav className="hidden sm:flex items-center gap-5 text-[12px] text-[#1a1814]/55">
          ...
          <Link
            href="/app"
            className="text-[12px] font-semibold text-[#3d8f5c] hover:text-[#2d6b45]"
          >
            Open app
          </Link>
        </div>
      ...
      <section className="px-4 pt-7 pb-5 sm:pt-10 sm:pb-6">
        <div className="mx-auto max-w-5xl grid lg:grid-cols-2 gap-5 lg:gap-8 items-center">
          <div className="space-y-3 order-2 lg:order-1">
            <p className="text-[10px] tracking-[0.16em] uppercase text-[#1a1814]/45 font-medium">
              Asia-first · Photo AI · 1000+ dishes and counting, updated weekly
            </p>
            <h1 className="font-semibold tracking-[-0.035em] leading-[1.02] text-[clamp(1.85rem,4.8vw,2.85rem)]">
              Easy to use.
              <br />
              Hard to fool
              <br />
            ...
            <p className="text-[13px] leading-snug text-[#1a1814]/55 max-w-sm">
              Snap or type rice bowls, noodles, curry, hawker sets. Not Western defaults.
            </p>
            <div className="flex flex-wrap gap-2 pt-0.5">
              <Link
                href="/app"
                className="inline-flex h-9 px-5 items-center rounded-full bg-[#1a1814] text-[#f6f3ee] text-[12px] font-semibold hover:bg-[#3d8f5c] transition-colors"
              >
                Try free
              </Link>
              <Link
                href="/library"
                className="inline-flex h-9 px-5 items-center rounded-full border border-[#1a1814]/12 text-[12px] font-medium hover:border-[#1a1814]/30 transition-colors"
              >
                Library
              </Link>
            </div>
            <div className="pt-1 max-w-md">
              <p className="text-[10px] font-semibold text-[#1a1814]/40 uppercase tracking-wide mb-1.5">
                Install on phone
              </p>
              <div className="grid grid-cols-2 gap-1.5 text-[11px] leading-snug text-[#1a1814]/60">
                <div className="rounded-lg border border-[#1a1814]/8 bg-white/50 px-2.5 py-2">
                  <div className="font-semibold text-[#1a1814] text-[11px] mb-0.5">iPhone</div>
                  <p>Safari → Share → Add to Home Screen</p>
                </div>
                <div className="rounded-lg border border-[#1a1814]/8 bg-white/50 px-2.5 py-2">
                  <div className="font-semibold text-[#1a1814] text-[11px] mb-0.5">Android</div>
      ...
      <section id="how" className="px-4 py-8 sm:py-10">
        <div className="mx-auto max-w-5xl">
          <p className="text-[10px] tracking-[0.16em] uppercase text-[#1a1814]/40 font-medium mb-1.5">
            How it works
          </p>
          <h2 className="text-lg sm:text-xl font-semibold tracking-tight mb-1">
            Snap, type, or re-log. Built for how Asia eats.
          </h2>
          <p className="text-[12px] text-[#1a1814]/45 mb-4 max-w-lg">
          ...
          <div className="grid sm:grid-cols-3 gap-2">
            {[
              ...
              >
                <div className="text-[13px] font-semibold mb-0.5">{x.t}</div>
                <p className="text-[12px] text-[#1a1814]/55 leading-snug">{x.d}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="why" className="px-4 py-8 sm:py-10 bg-[#ebe6dc]/60 border-y border-[#1a1814]/8">
        <div className="mx-auto max-w-5xl">
          ...
          <h2 className="text-lg sm:text-xl font-semibold tracking-tight max-w-md mb-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-1.5">
            {[
              ...
              <div
                key={t}
                className="rounded-lg border border-[#1a1814]/8 bg-[#f6f3ee] px-3 py-2.5 text-[12px] font-medium"
              >
                {t}
              </div>
            ))}
      ...
      <section className="px-4 py-10 sm:py-12 text-center">
        ...
        <Link
          href="/app"
          className="mt-4 inline-flex h-9 px-7 items-center rounded-full bg-[#1a1814] text-[#f6f3ee] text-[12px] font-semibold hover:bg-[#3d8f5c] transition-colors"
        >
          Open RiceTrack
        </Link>
      </section>

      <footer className="px-4 py-7 border-t border-[#1a1814]/8 text-[11px] text-[#1a1814]/45">
        <div className="mx-auto max-w-5xl flex flex-col gap-5">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-5">
            <div className="space-y-1 max-w-xs">
              <div className="flex items-center gap-1.5 text-[13px] font-semibold text-[#1a1814]/70">
                <RiceLogo size={20} />
                RiceTrack
              </div>
            ...
            <div className="grid grid-cols-2 gap-6 text-[12px]">
              <div className="space-y-1.5">
                <div className="font-semibold text-[#1a1814]/50 uppercase tracking-wide text-[9px]">
                  Product
                </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-1 pt-3 border-t border-[#1a1814]/8 text-[10px]">
