    ...
    <div className="min-h-screen bg-[#f6f3ee] text-[#1a1814]">
      <header className="sticky top-0 z-50 border-b border-[#1a1814]/8 bg-[#f6f3ee]/95 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-12 flex items-center justify-between">
          ...
          <Link href="/app" className="text-[12px] font-medium text-[#2d5a3d]">Open →</Link>
        </div>
      </header>

      {/* Hero — tight */}
      <section className="px-4 sm:px-6 pt-8 sm:pt-10 pb-8">
          ...
          <div className="relative order-1 lg:order-2">
            <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
              <div className="col-span-1 row-span-2 rounded-xl overflow-hidden shadow-md">
                ...
                <img src={FOOD[0].src} alt={FOOD[0].alt} className="w-full h-full object-cover aspect-[3/5]" width={360} height={600} />
              </div>
              <div className="rounded-xl overflow-hidden shadow-md">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={FOOD[1].src} alt={FOOD[1].alt} className="w-full object-cover aspect-square" width={280} height={280} />
              </div>
              <div className="rounded-xl overflow-hidden shadow-md">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={FOOD[2].src} alt={FOOD[2].alt} className="w-full object-cover aspect-square" width={280} height={280} />
              </div>
              <div className="col-span-2 rounded-xl overflow-hidden shadow-md">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={FOOD[3].src} alt={FOOD[3].alt} className="w-full object-cover aspect-[2/1]" width={560} height={280} />
              </div>
            </div>
            <div className="absolute -bottom-2 left-0 w-[40%] rounded-xl overflow-hidden shadow-xl border-[3px] border-[#f6f3ee] -rotate-3 z-10">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={FOOD[4].src} alt={FOOD[4].alt} className="w-full aspect-[4/3] object-cover" width={280} height={210} />
            </div>
            <div className="absolute -top-1.5 right-0 w-[26%] rounded-lg overflow-hidden shadow-lg border-[3px] border-[#f6f3ee] rotate-6 z-10">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={FOOD[5].src} alt={FOOD[5].alt} className="w-full aspect-square object-cover" width={160} height={160} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Strip — shorter */}
      <section className="grid grid-cols-4 h-24 sm:h-32 mt-4">
