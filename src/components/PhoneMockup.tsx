...
const STEPS = 4;
const STEP_MS = 2800;
const PLATE = "/food/yang-chow-fried-rice.png";
      ...
      <div className="relative rounded-[2.35rem] bg-[#1a1814] p-[10px] shadow-[0_28px_60px_-20px_rgba(26,24,20,0.45)] ring-1 ring-black/20">
        ...
        <div className="relative overflow-hidden rounded-[1.85rem] bg-[#f7f2ea] aspect-[9/19.5] text-[#1a1814]">
          ...
          <div className="relative h-[calc(100%-52px)] overflow-hidden">
            ...
            {/* Step 1 — photo captured (yang chow fried rice) */}
            ...
            <Screen visible={step === 3}>
              <div className="flex gap-2 items-start">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-[12px] font-semibold leading-tight">Yang Chow fried rice</div>
                  <div className="text-[9px] text-[#1a1814]/45 mt-0.5">Chinese · 1 plate</div>
                </div>
              </div>
              ...
              <div className="mt-2 space-y-1.5">
                {[
                  ["Yang Chow fried rice", "380 kcal"],
                  ["Shrimp", "70 kcal"],
                  ["Egg", "60 kcal"],
                  ["BBQ pork & veg", "90 kcal"],
                ].map(([name, cal]) => (
                  <div
                    key={name}
